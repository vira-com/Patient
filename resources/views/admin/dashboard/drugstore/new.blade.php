...
@section('main')
    ...
    <section class="content">
        <div class="box">
            <div class="box-body">
                {!! Form::open(['url' => '/admin/panel/drugstore/save', 'method' => 'post' ,'enctype'=>'multipart/form-data']) !!}
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="pharmacyName" id="pharmacyName" placeholder="نام داروخانه" >
                    </div>
                    <div class="form-group">
                        <label for="mobile">شماره موبایل</label>
                        <input type="text" class="form-control" name="mobile" maxlength="11" id="mobile" placeholder="09000000000" >
                    </div>
                    <div class="form-group">
