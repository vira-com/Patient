    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="" class="logo">
                ...
                <span class="logo-mini">{{ __('dashboard.admin_mini_panel_controller') }}</span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>{{ __('dashboard.admin_panel_controller') }}</b></span>
            </a>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-left">
                                        <a href="{{url('admin/panel/logout')}}" class="btn btn-default btn-flat">
                                            {{ __('dashboard.exit') }}
                                        </a>
                                    </div>
                                </li>
                    ...
                    <li class="@if(Request::url() === asset('/admin/panel/dashboard')) active @endif treeview">
                        ...
                        <ul class="treeview-menu">
                            <li class="@if(Request::url() === asset('/admin/panel/dashboard')) active @endif"><a
                                    href="/admin/panel/dashboard"><i class="fa fa-circle-o"></i>
