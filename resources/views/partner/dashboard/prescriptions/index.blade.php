                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($drugPrescription['status'] == 1)
                                                <a href="/admin/panel/prescription/{{$drugPrescription['id']}}"  class="btn btn-block btn-warning btn-sm">بررسی</a>
                                            @elseif($drugPrescription['status'] == 2)
                                                <a href="/admin/panel/prescription/cost/{{$drugPrescription['id']}}"  class="btn btn-block btn-danger btn-sm">ثبت قیمت</a>
