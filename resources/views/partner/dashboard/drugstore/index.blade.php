...
<section class="content">
    ...
    <div id="delete{{$drugstore->id}}" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                {!! Form::open(['url' => '/partner/panel/drugstore/deactive/'.$drugstore->id, 'method' => 'post']) !!}
                ...
                <div class="modal-body">
                    ...
                    <p style="font-size:14px;">آیا از غیرفعال کردن داروخانه <strong>{{$drugstore->pname}}</strong> با
                        <span style="color:#c75757;">کد {{$drugstore->id}} </span> اطمینان دارید؟</p>
    ...
    <div id="active{{$drugstore->id}}" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <!-- Modal content-->
            <div class="modal-content">
                {!! Form::open(['url' => '/partner/panel/drugstore/active/'.$drugstore->id, 'method' => 'post']) !!}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
