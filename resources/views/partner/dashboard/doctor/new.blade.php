...
@section('main')
    ...
    <section class="content">
        <div class="box">
            <div class="box-body">
                {!! Form::open(['url' => '/admin/panel/doctor/save', 'method' => 'post' ,'enctype'=>'multipart/form-data']) !!}
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="docMobile" maxlength="11" id="docMobile" placeholder="09000000000" >
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="docNationalCode" id="docNationalCode" placeholder="کد ملی" >
                    </div>
                    <div class="form-group">
