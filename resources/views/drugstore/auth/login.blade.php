...
<body class="hold-transition login-page">
    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            {!!
            Form::open(['url'=>'drugstore/panel/loginhandle','id'=>'CheckForm','method'=>'post','class'=>'text-left'])
            !!}
            ...
            {{--<a href="/panel/restpassword">رمز عبورم را فراموش کرده ام.</a><br>--}}
            {{--<a href="/panel/register" class="text-center">ثبت نام</a>--}}
    ...
    $("#CheckForm").submit(function (e) {
        $.ajax({
            type: 'POST',
            url: '/drugstore/ajax/login',
            dataType: 'json',
            data: $(this).serialize(),
            success: function (data) {
                if (data.success == 'no') {
                    var x = document.getElementById("snackbar");
                    x.className = x.className.replace("panelcss-hide", "show");
